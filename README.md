...
This is a sample template for sns-latency-test - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sns-latency-test --query 'Stacks[].Outputs'
```
